...
data class BlocksGenerated(val offset: Vector3i, val blocks: ObjectSpace<BlockType>, override val cause: Cause, override val context: MultiTypeMap = MultiTypeMap()): Message
