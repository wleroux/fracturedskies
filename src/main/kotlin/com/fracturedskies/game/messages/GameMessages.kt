...
data class SpawnWorker(val id: Id, val initialPos: Vector3i, override val cause: Cause, override val context: Context): Message
data class MoveWorkers(val movements: Map<Id, Vector3i>, override val cause: Cause, override val context: Context): Message