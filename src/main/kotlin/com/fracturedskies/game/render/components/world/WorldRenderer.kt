...
class WorldRenderer(attributes: Context) : AbstractComponent<Unit>(attributes, Unit) {
  ...
  private fun updateBlockMesh(world: ObjectMap<com.fracturedskies.game.render.components.world.Block>, chunk: Vector3i) {
  ...
  private fun updateWaterMesh(world: ObjectMap<com.fracturedskies.game.render.components.world.Block>, chunk: Vector3i) {
  ...
  lateinit private var skyLightLevels: com.fracturedskies.game.render.components.world.LightLevels
  lateinit private var blockLightLevels: com.fracturedskies.game.render.components.world.LightLevels
  override fun willMount() = runBlocking<Unit> {
    program = ColorShaderProgram()
    skyLightLevels = com.fracturedskies.game.render.components.world.LightLevels.load(loadByteBuffer("SkyLightLevels.png", WorldRenderer::class.java), 240)
    blockLightLevels = com.fracturedskies.game.render.components.world.LightLevels.load(loadByteBuffer("BlockLightLevels.png", WorldRenderer::class.java), 16)
  ...
  private fun heightAt(world: ObjectMap<com.fracturedskies.game.render.components.world.Block>, x: Int, z: Int, yRange: IntRange): Int {
