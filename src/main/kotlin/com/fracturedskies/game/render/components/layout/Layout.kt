...
class Layout(attributes: Context) : AbstractComponent<Unit>(attributes, Unit) {
  companion object {
    // Flex Attributes
    val DIRECTION = Key<com.fracturedskies.game.render.components.layout.Direction>("direction")
    val JUSTIFY_CONTENT = Key<com.fracturedskies.game.render.components.layout.JustifyContent>("justifyContent")
    val ALIGN_ITEMS = Key<com.fracturedskies.game.render.components.layout.ItemAlign>("itemAlign")
    val ALIGN_CONTENT = Key<com.fracturedskies.game.render.components.layout.ContentAlign>("contentAlign")
    val WRAP = Key<com.fracturedskies.game.render.components.layout.Wrap>("wrap")

    // Item Attributes
    val GROW = Key<Double>("grow")
    val SHRINK = Key<Double>("shrink")
    val ALIGN_SELF = Key<com.fracturedskies.game.render.components.layout.ItemAlign>("alignSelf")

    fun Node.Builder<*>.layout(
        direction: com.fracturedskies.game.render.components.layout.Direction = com.fracturedskies.game.render.components.layout.Direction.ROW,
        justifyContent: com.fracturedskies.game.render.components.layout.JustifyContent = com.fracturedskies.game.render.components.layout.JustifyContent.LEFT,
        alignItems: com.fracturedskies.game.render.components.layout.ItemAlign = com.fracturedskies.game.render.components.layout.ItemAlign.START,
        alignContent: com.fracturedskies.game.render.components.layout.ContentAlign = com.fracturedskies.game.render.components.layout.ContentAlign.START,
        wrap: com.fracturedskies.game.render.components.layout.Wrap = com.fracturedskies.game.render.components.layout.Wrap.WRAP,
    ...
    /* Helper Functions */
    private fun Component<*>.cross(direction: com.fracturedskies.game.render.components.layout.Direction, width: Int, height: Int): Int {
    ...
    private fun Component<*>.main(direction: com.fracturedskies.game.render.components.layout.Direction, width: Int, height: Int): Int {
      val preferredWidth = this.preferredWidth(width, height)
      val preferredHeight = this.preferredHeight(width, height)
