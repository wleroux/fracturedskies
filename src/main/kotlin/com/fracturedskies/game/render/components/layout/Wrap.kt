...
enum class Wrap {
  WRAP {
    override fun split(components: List<Component<*>>, direction: com.fracturedskies.game.render.components.layout.Direction, width: Int, height: Int): List<List<Component<*>>> {
  ...
  abstract fun split(components: List<Component<*>>, direction: com.fracturedskies.game.render.components.layout.Direction, width: Int, height: Int): List<List<Component<*>>>
}
