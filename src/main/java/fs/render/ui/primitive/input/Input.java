package fs.render.ui.primitive.input;

import fs.render.Component;
import fs.render.event.*;
import fs.render.ui.layout.Card;
import fs.render.ui.primitive.button.Base;
import fs.render.ui.primitive.label.Label;
import fs.render.ui.primitive.label.LabelMeshGenerator;
...
public class Input extends Component {
  ...
  public Input text(String text) {
    if (!textField.text().equals(text)) {
      textField.text(text);
      UIEvent.dispatch(new TextChanged(this, text));
    }
